...
| 파일 | 설명 |
| --- | --- |
| [cpp.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/cpp.md) | C++ 문자열 분리/타입 변환 스니펫, Google C++ Style |
...
| [_archive/sed-awk.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/sed-awk.md) | sed/awk 텍스트 처리 |
...
| 파일 | 설명 |
| --- | --- |
| [_archive/windows-terminal.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/windows-terminal.md) | Windows Terminal 키바인딩, settings.json |
...
| [_archive/rocky-linux.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/rocky-linux.md) | Rocky Linux 관리 |
...
| 파일 | 설명 |
| --- | --- |
| [_archive/jenv.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/jenv.md) | Java 버전 관리 |
| [_archive/nvm.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/nvm.md) | Node 버전 관리 |
...
| [_archive/nikto.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/nikto.md) | 웹 취약점 스캔 |
...
| 파일 | 설명 |
| --- | --- |
| [_archive/ncp-networking.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/ncp-networking.md) | NCP 콘솔 |
| [_archive/compression.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/compression.md) | tar/gzip/zip |
| [_archive/leetcode-cli.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/_archive/leetcode-cli.md) | 코딩 테스트 |
