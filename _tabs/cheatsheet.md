...
| [linux.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/linux.md) | Linux 디렉터리 구조 + 자원 모니터링 + 네트워크 |
| [ssh.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/ssh.md) | ssh-agent/ssh-add, ~/.ssh/config, scp/rsync |
| [systemd.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/systemd.md) | systemd 서비스 관리 + journalctl 로그 |
...
| 파일 | 설명 |
|------|------|
| [macos-admin.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/macos-admin.md) | macOS troubleshoot (LaunchDaemons, Secure Input 등) |
| [aerospace.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/aerospace.md) | macOS 타일링 WM |
...
| [elasticsearch.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/elasticsearch.md) | Elasticsearch 쿼리/관리 |
| [kibana.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/kibana.md) | KQL, Dev Tools, Discover, 운영 진단 |
...
| 파일 | 설명 |
|------|------|
| [c-cpp.md](https://github.com/clang-engineer/toolbox/blob/main/cheatsheets/c-cpp.md) | C/C++ 스니펫 + Google C++ Style + GDB 디버거 |
