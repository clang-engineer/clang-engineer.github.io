...
> 관련: SonarQube가 정적 분석(코드 품질)을 담당한다면, 런타임 관측은 [JHipster 모니터링 — Actuator·Prometheus·Grafana 스택](./2025-10-05-monitoring.md)과 [Spring Boot Actuator 상세 설정](./2025-10-05-actuator.md)에서 다룹니다.
