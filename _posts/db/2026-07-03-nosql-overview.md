...
| 글 | 요약 |
|----|------|
| [CAP 정리 — P는 고르는 게 아니라 주어진다](./2026-07-03-cap-theorem.md) | NoSQL이 택하는 일관성·가용성 트레이드오프의 이론 |
| [분산 DB 확장 — 샤딩·분산 트랜잭션·합의](./2026-07-03-distributed-db-scaling.md) | NoSQL이 수평 확장에 강한 이유 — 샤딩·복제 |
