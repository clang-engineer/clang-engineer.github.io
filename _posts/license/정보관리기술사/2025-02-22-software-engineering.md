...
> 통신적: 동일한 입력과 출력을 사용하여 다른 기능을 수행하는 구성 요소들이 모였을 때
...
단점 
> 개발 장기화, 비용 증가 가능성, <br>
> 위험 관리 능력이 프로젝트 성공에 큰 영향을 미침 <br로
> 프로젝트 관리가 복잡함
...
전통적 방법론과의 차이점
> 전통적 방법론은 계획과 문서화에 중점을 두는 반면, Agile 방법론은 사람과 상호작용, 고객과의 협력, 변화에 대한 적응을 중시함 <br>
...
- 일반화(Generalization): 하나의 사물이 다른 사물에 비해 더 일바적이거나 구체적인 관계, 빈 삼각형으로 표현
- 의존(Dependency): 한 사물이 다른 사물에 의존하는 관계, 점선 화살표로 표현 (영향을 주는 쪽으로 화살표를 그린다)
...
## 50. UML에서 관계표시는 4가지(연관, 의존, 일반화, 실체화)로 표시된다. 각각 설명하고 실생활에서 사용되는 예를 Notation하여 설명하시오. (집합연관과 합성연관도 설명하시오)
> -
