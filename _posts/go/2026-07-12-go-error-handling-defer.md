...
일반 실패 모델의 비교 자체는 [에러 핸들링 모델](https://github.com/clang-engineer/clang-engineer.github.io/blob/main/_archive/정보관리기술사/05-소프트웨어-공학/_보충학습/프로그래밍-언어-의미론.md)에 두고, 이 글은 Go의 구체 의미론에 집중한다.
