...
>
> **언어 공통 개념**: "함수가 바깥 변수를 기억한다"는 클로저 자체는 언어 무관 개념 → [클로저란 무엇인가](../concept/2026-07-12-closure.md). 이 글은 그 **C++ 구현(람다)**에 집중합니다.
...
STL 알고리즘의 술어를 타입에 얽매이지 않게 짤 때 편합니다. → [제네릭 — 파라미터 다형성](../concept/2026-07-12-generics-parametric-polymorphism.md)의 그 아이디어가 람다에도 붙은 것입니다.
