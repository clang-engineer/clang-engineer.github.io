...
> 관련 시리즈: [키보드 로드맵](./2026-07-03-keyboard-roadmap.md) · [세벌식 390 입문](./2026-07-03-sebeolsik-390-intro.md) · [ZMK 키맵 설계기](./2026-07-03-zmk-keymap-hhkb-sebeolsik-40.md)
...
실제로 HHKB를 오래 쓰다 보면 몸에 배는 대표적 습관이 **좌 Ctrl(Caps 자리)**, **Fn+방향키**, 그리고 **손 가까운 삭제키 위치**다. 이 습관들은 커스텀 키보드로 넘어가도 그대로 재현하고 싶어지는데, 그 이야기는 [ZMK 키맵 설계기](./2026-07-03-zmk-keymap-hhkb-sebeolsik-40.md)에서 이어진다.
