...
> 관련: 개인 플랜에서 단순히 기본 모델이 미지원으로 바뀐 경우라면 `:CopilotChatModels` → Auto 로 끝난다 → [CopilotChat.nvim Model not found 에러 — :CopilotChatModels로 Auto 선택](./2026-06-05-copilotchat-model-not-found.md)
