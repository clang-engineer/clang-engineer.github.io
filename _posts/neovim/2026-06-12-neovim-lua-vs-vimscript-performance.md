...
| **Lua vs Vimscript 성능 (현재 글)** | LuaJIT vs 트리 워킹 인터프리터, 진짜 차이 나는 영역과 측정법 |
| [runtimepath 디렉토리 관례](./2026-06-12-neovim-plugin-conventions.md) | `plugin/` vs `lua/`, 헬프·헬스체크·after/ 자동 로드 규칙 |
