...
- 업스트림 버그로 특정 요청만 깨질 때 (예: fwcd/kotlin-language-server v1.3.13 #600의 `documentHighlight` 크래시 — [import 안 잡히는 캐시 문제](./2026-06-16-kotlin-language-server-stale-kls-database.md)와 혼동 주의)
