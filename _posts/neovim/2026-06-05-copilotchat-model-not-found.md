...
> 관련: Auto/모델 선택으로도 안 풀리고 `Resolved model not found:` 가 뜬다면 Business 조직 정책 케이스다 → [Copilot Business + CopilotChat.nvim "Model not found" 진단](./2026-06-17-copilotchat-copilot-business-model-not-found.md)
