...
> 관련: [AI 로드맵](./2026-07-03-ai-roadmap.md)의 **저변·원리** 갈래 · 개념은 [MCP 개념 정리](./2025-10-23-mcp.md), 첫 구현체는 [Serena 기본 가이드](./2025-11-07-serena-mcp.md)에서.

[MCP가 무엇인지](./2025-10-23-mcp.md) 잡고 [Serena](./2025-11-07-serena-mcp.md) 하나를 붙여봤다면, 이제 **여러 서버를 실제로 등록하고 관리**하는 단계다. 이 글은 Claude Code에 MCP 서버를 붙이는 문법과, 붙일 만한 서버들, 그리고 보안 주의점을 정리한다.
...
정리하면 — **붙이는 건 `claude mcp add` 한 줄**이지만, 스코프·전송·신뢰를 함께 판단해야 한다. 개념 복습은 [MCP 개념 정리](./2025-10-23-mcp.md), 의미 기반 코드 검색 서버 하나를 제대로 세팅하는 흐름은 [Serena 기본 가이드](./2025-11-07-serena-mcp.md). 전체 경로는 [AI 로드맵](./2026-07-03-ai-roadmap.md).
