...
| [NoClassDefFoundError — POM transitive 의존성 누락](./2026-05-15-noclassdeffounderror-missing-transitive-dep.md) | published POM에 빠진 모듈이 런타임 클래스패스에서 누락 |
| [Gradle 데몬 환경변수 stale 문제](./2026-05-20-gradle-daemon-stale-env-vars.md) | 데몬이 옛 환경변수를 잡고 있어 PAT 갱신이 반영되지 않는 함정 |
