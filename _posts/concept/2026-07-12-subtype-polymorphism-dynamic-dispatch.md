...
updated     : 2026-07-12 14:50:00 +0900
categories  : [concept]
...
> **아 ~구나 포인트.** Rust의 `Box<dyn Trait>`나 Go의 인터페이스 값이 왜 포인터보다 큰지 헷갈렸다면 — **C++ 객체가 `vptr`을 품는 대신, 이 언어들은 그 vptr을 포인터 옆에 붙여 들고 다니는 것**이다. 같은 vtable, 다른 보관 위치.
