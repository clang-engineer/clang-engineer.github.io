...
## 14. Covering Index에서는 왜 Row까지 가지 않는가

Non-clustered Index에 Row Locator가 있다고 해서 모든 조회에서 반드시 원본 Row까지 접근하는 것은 아니다.
...
> **Covering Index라고 Row Locator가 없어지는 것이 아니라, 해당 Query에서 Row Locator를 따라갈 필요가 없는 것이다.**
