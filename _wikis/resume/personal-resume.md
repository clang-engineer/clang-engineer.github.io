...
- 개발 환경에서 database를 h2 파일 서버로 설정하여 network나 별도 외부 상황에 영향을 받지 않도록 하였습니다.
...
- 1차 캐시 설정시 일관성 보장이 필요한 엔티티에 대해서는 READ_WRITE, 일관성이 보장되지 않아도 되는 엔티티에 대해서는 NONSTRICT_READ_WRITE를 사용하여 성능을 향상시켰습니다.
